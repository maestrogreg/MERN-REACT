...
var getStudent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var allStudents, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, students_1.default.find()];
            case 1:
                allStudents = _a.sent();
            ...
            case 2:
                error_1 = _a.sent();
                res.status(404).json({ status: "error", message: error_1.message });
                return [3 /*break*/, 3];
...
var createStudent = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var studentCreated, newStudent, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                studentCreated = req.body;
                newStudent = new students_1.default(studentCreated);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
            ...
            case 3:
                error_2 = _a.sent();
                res.status(409).json({ status: "error", message: error_2.message });
                return [3 /*break*/, 4];
